      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-xl p-6 shadow-lg border border-gray-200 max-w-xs">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 bg-[#3EC1D3]/10 rounded-lg flex items-center justify-center">
                  <CheckCircle2 size={20} className="text-[#3EC1D3]" />
                </div>
                <p className="text-gray-900 font-display font-semibold text-sm">9 de cada 10 pacientes</p>
              </div>
          ...
          <div>
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <span className="text-[#2A6F97]">antes de venir</span>
            </h2>
            ...
            <ul className="space-y-3 mb-10">
              {reassurances.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <CheckCircle2 size={18} className="text-[#2A6F97] mt-0.5 flex-shrink-0" />
            ...
            <button
              ...
              className="btn-primary text-white font-semibold px-8 py-4 rounded-lg inline-block"
            >
