        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
              No adivinamos.{' '}
              <span className="text-[#2A6F97]">Te mostramos</span>{' '}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {points.map((point) => (
              <div key={point.title} className="card-glass rounded-xl p-5 hover:shadow-md transition-all hover-lift">
                <div className="w-10 h-10 bg-[#2A6F97]/10 rounded-lg flex items-center justify-center mb-4">
                  <point.icon size={20} className="text-[#2A6F97]" />
                </div>
                <h3 className="text-gray-900 font-display font-semibold text-sm mb-2">{point.title}</h3>
